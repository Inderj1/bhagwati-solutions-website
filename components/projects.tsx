...
const products = [
  ...
  {
    id: 5,
    title: "PVC Modular Kitchens",
    category: "Waterproof Design",
    description: "Durable, waterproof PVC kitchen layouts with premium hardware and fittings",
    price: "Custom Pricing",
